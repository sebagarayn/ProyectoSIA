        ...
        if(cliente.getMascotas().isEmpty()){
            ...
            for(Mascota mascota: cliente.getMascotas()){
                ...
                if(mascota instanceof MascotaGeriatrica){
                    ...
                    reporte.append("  *** MASCOTA GERIÁTRICA ***\n");
                    ...
                    reporte.append("  Frecuencia visitas: ").append(geriatrica.obtenerFrecuenciaVisitas()).append(" meses\n");
                    ...
                    reporte.append("  Frecuencia visitas: ").append(mascota.obtenerFrecuenciaVisitas()).append(" meses\n");
                }
                    ...
                    for(Servicio servicio: mascota.getServicios()){
                            ...
                            if(servicio instanceof ServicioUrgencia){
                                ...
                                if(urgencia.esEmergenciaCritica()){
                                    reporte.append("    ├─️ EMERGENCIA CRÍTICA ️\n");
                                }
                                else{
                                    reporte.append("    ├─ Precio: $").append(servicio.getPrecio()).append("\n");
                                }
